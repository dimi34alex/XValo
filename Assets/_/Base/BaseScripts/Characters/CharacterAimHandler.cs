...
public class CharacterAimHandler : MonoBehaviour, EnemyHandler.IEnemyTargetable {
	...
	private void Start () {
        V_Object vObject = CreateBasicUnit(transform, new Vector3(500, 680), 30f, GameAssetsOld.i.m_MarineSpriteSheet);
        ...
        V_UnitSkeleton_Composite_WeaponInvert unitSkeletonCompositeWeapon = new V_UnitSkeleton_Composite_WeaponInvert(vObject, unitSkeleton, GameAssetsOld.UnitAnimEnum.dMarine_AimWeaponRight, GameAssetsOld.UnitAnimEnum.dMarine_AimWeaponRightInvertV, GameAssetsOld.UnitAnimEnum.dMarine_ShootWeaponRight, GameAssetsOld.UnitAnimEnum.dMarine_ShootWeaponRightInvertV);
        vObject.AddRelatedObject(unitSkeletonCompositeWeapon);
        unitSkeletonCompositeWeapon.SetActive();
            
        V_UnitSkeleton_Composite_Walker unitSkeletonCompositeWalker_BodyHead = new V_UnitSkeleton_Composite_Walker(vObject, unitSkeleton, GameAssetsOld.UnitAnimTypeEnum.dMarine_Walk, GameAssetsOld.UnitAnimTypeEnum.dMarine_Idle, new[] { "Body", "Head" });
        vObject.AddRelatedObject(unitSkeletonCompositeWalker_BodyHead);
            
        V_UnitSkeleton_Composite_Walker unitSkeletonCompositeWalker_Feet = new V_UnitSkeleton_Composite_Walker(vObject, unitSkeleton, GameAssetsOld.UnitAnimTypeEnum.dMarine_Walk, GameAssetsOld.UnitAnimTypeEnum.dMarine_Idle, new[] { "FootL", "FootR" });
        ...
        FunctionUpdater.Create(() => {
            ...
            if (canShoot && Input.GetMouseButton(0)) {
                ...
                unitSkeleton.ReplaceBodyPartSkeletonAnim(GameAssetsOld.UnitAnimTypeEnum.dMarine_Attack.GetUnitAnim(aimDir), "Body", "Head");
