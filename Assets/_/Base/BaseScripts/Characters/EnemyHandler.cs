...
public class EnemyHandler : MonoBehaviour {
    ...
    public static EnemyHandler Create(Vector3 position) {
        Transform enemyTransform = Instantiate(GameAssetsOld.i.pfEnemy, position, Quaternion.identity);
    ...
    private void Start() {
        ...
        bodyTransform.GetComponent<MeshRenderer>().material = GameAssetsOld.i.m_MarineSpriteSheet;
