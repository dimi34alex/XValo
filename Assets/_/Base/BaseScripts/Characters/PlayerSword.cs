    ...
    private void HandleAttack() {
        if (Input.GetMouseButtonDown(0)) {
            ...
            if (activeAnimType == GameAssetsOld.UnitAnimTypeEnum.dSwordTwoHandedBack_Sword) {
                ...
                characterBase.GetUnitAnimation().PlayAnimForced(GameAssetsOld.UnitAnimTypeEnum.dSwordTwoHandedBack_Sword2, attackDir, 1f, (UnitAnim unitAnim) => SetStateNormal(), null, null);
            } else {
                characterBase.GetUnitAnimation().PlayAnimForced(GameAssetsOld.UnitAnimTypeEnum.dSwordTwoHandedBack_Sword, attackDir, 1f, (UnitAnim unitAnim) => SetStateNormal(), null, null);
            }
        }
    }
