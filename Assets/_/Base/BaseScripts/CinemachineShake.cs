...
public class CinemachineShake : MonoBehaviour {
        ...
        if (Instance == null) {
            ...
            if (cinemachineVirtualCamera == null) {
                ...
                if (cinemachineBasicMultiChannelPerlin == null) {
                    ...
                    cinemachineBasicMultiChannelPerlin.NoiseProfile  = GameAssetsOld.i.cinemachineDefaultNoiseProfile;
                    cinemachineBasicMultiChannelPerlin.FrequencyGain  = 5f;
                }
    ...
    public void ScreenShake(float intensity = 1f, float timer = .1f) {
        ...
        FunctionTimer.Create(() => { cinemachineBasicMultiChannelPerlin.AmplitudeGain  = 0f; }, timer);
    }
