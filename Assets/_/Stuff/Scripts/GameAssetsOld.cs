...
public class GameAssetsOld : MonoBehaviour {
    
    private static GameAssetsOld _i;

    public static GameAssetsOld i {
        get {
            if (_i == null) _i = Instantiate(Resources.Load<GameAssetsOld>("GameAssetsOld"));
            return _i;
        }
    }
    ...
    public Unity.Cinemachine.NoiseSettings cinemachineDefaultNoiseProfile;
