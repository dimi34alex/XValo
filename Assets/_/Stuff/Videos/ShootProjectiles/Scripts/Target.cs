...
public class Target : MonoBehaviour {
    ...
    public void Damage() {
        ...
        // 3D
        Transform smokeTransform = Instantiate(GameAssetsOld.i.pfSmoke, transform.position + new Vector3(0, 1.8f) + UtilsClass.GetRandomDir() * Random.Range(0f, 0.2f), Quaternion.identity);
